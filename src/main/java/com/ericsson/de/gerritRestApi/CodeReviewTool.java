...
import com.ericsson.de.chartGenerator.chartGenerator;
...
public final class CodeReviewTool 
{
	...
	{		
		...
		String signum = console.readLine("Signum: ");
        char password[] = console.readPassword("Password: ");

		GerritAuthData.Basic authData = new GerritAuthData.Basic("https://gerrit.ericsson.se", signum, new String(password));
	...
	private static void mainMenu () throws RestApiException
	{
		...
		Options option1 = new Options("Email", "1");
		Options option2 = new Options("Guardian Group", "2");
		Options option3 = new Options("Project", "3");
		Options option4 = new Options("Quit", "4");
		...
		mainMenu.addRow(option1.getNumber(), option1.name());
		mainMenu.addRow(option2.getNumber(), option2.name());
		mainMenu.addRow(option3.getNumber(), option3.name());
		mainMenu.addRow(option4.getNumber(), option4.name());
		mainMenu.print();
		...
		while (again)
		{
			...
			{
				if (option.equalsIgnoreCase(opt.getCharacter()) ||  option.equalsIgnoreCase(opt.name()) || option.equals(opt.getNumber()))
				{
	...
	private static int displayMenu ()
	{
		...
		Options option1 = new Options("Perentage", "1");
		Options option2 = new Options("detailed table", "2");
		Options option3 = new Options("Lines", "3");
	...
	public static boolean anonymousView ()
	{
		...
		Options option1 = new Options("Yes", "1");
		Options option2 = new Options("No", "2");
		...
		for (Options opt : options)
		{				
			if (answer.equalsIgnoreCase(opt.getCharacter()) ||  answer.equalsIgnoreCase(opt.name()) || answer.equals(opt.getNumber()))
			{
				optValue = opt.getValue();
				break;
			}
	...
	private static void showLinesOfCode (List<ChangeInfo> changes) {
